#ifndef VOID_ENGINE_RENDERER_BUFFER_ELEMENT_BUFFER_HPP
#define VOID_ENGINE_RENDERER_BUFFER_ELEMENT_BUFFER_HPP
...
#endif // !VOID_ENGINE_RENDERER_BUFFER_ELEMENT_BUFFER_HPP
