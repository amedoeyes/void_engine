#ifndef VOID_ENGINE_RENDERER_BUFFER_VERTEX_BUFFER_HPP
#define VOID_ENGINE_RENDERER_BUFFER_VERTEX_BUFFER_HPP
...
#endif // !VOID_ENGINE_RENDERER_BUFFER_VERTEX_BUFFER_HPP
